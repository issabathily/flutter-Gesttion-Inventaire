...
class DatabaseService {
  static late File _databaseFile;
  ...
  static Future<void> init() async {
    ...
    try {
      ...
      if (!await _databaseFile.exists()) {
        ...
        await _databaseFile.writeAsString(jsonEncode(_data));
      } else {
        // Read existing data
        final fileContent = await _databaseFile.readAsString();
        _data = jsonDecode(fileContent);
      }
